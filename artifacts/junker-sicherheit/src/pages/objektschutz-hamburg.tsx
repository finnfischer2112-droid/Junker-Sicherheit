...
const faqItems = [
  {
    q: 'Was kostet Objektschutz in Hamburg?',
  ...
  {
    q: 'Wie schnell können Sie in Hamburg eingesetzt werden?',
  ...
  {
    q: 'Übernehmen Sie auch kurzfristige Einsätze in Hamburg?',
  ...
  {
    q: 'Was unterscheidet Junker-Sicherheit von anderen Anbietern in Hamburg?',
...
const hamburgDistricts = [
  'HafenCity', 'Altona', 'Wandsbek', 'Eimsbüttel', 'Harburg', 'Blankenese',
  'Barmbek', 'Bergedorf', 'Rahlstedt', 'Poppenbüttel', 'Pinneberg', 'Quickborn',
  'Norderstedt', 'Bad Segeberg', 'Itzehoe',
];
...
const services = [
  {
    ...
    desc: 'Schutz Ihrer Produktionsstätten, Büros und Gewerbeflächen in Hamburg – rund um die Uhr.',
  },
  {
    icon: Eye,
    title: 'Revierdienste Hamburg',
    desc: 'Mobile Streifenfahrten durch Hamburg – sichtbare Präsenz, die abschreckt.',
  },
  {
    icon: DoorOpen,
  ...
  },
  {
    ...
    desc: 'Individuelle Gefährdungsbeurteilung und Sicherheitsplan speziell für Ihr Hamburger Objekt.',
  },
  {
    icon: Phone,
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea
                  placeholder="z.B. Lagerhalle, 2.000 m², Harburg – Schutz Mo–Fr nachts und am Wochenende"
...
export default function ObjektschutzHamburg() {
  useEffect(() => {
    ...
    document.title = 'Objektschutz Hamburg | §34a ausgebildet · 24/7 · Junker-Sicherheit';
    ...
    const desc = 'Objektschutz Hamburg – §34a ausgebildet, inhabergeführt, sofort einsatzbereit. Werksschutz, Revierdienste & Zugangskontrolle für Hamburger Unternehmen. Kostenlose Erstberatung anfordern!';
  ...
  return (
    <div className="w-full overflow-hidden">
      ...
      <section className="relative min-h-[92vh] flex items-center bg-slate-900">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <img
            ...
            alt="Objektschutz Hamburg – Junker-Sicherheit"
        ...
        <div className="container mx-auto px-4 max-w-7xl relative z-20 pt-24 pb-28">
          <FadeIn delay={0.1} duration={0.7} className="max-w-3xl">
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary text-white text-sm font-semibold mb-7 shadow-lg">
              ...
              <span>Nr. 1 Objektschutz Hamburg</span>
            </div>
            ...
            <p className="text-lg md:text-xl text-slate-300 mb-8 max-w-2xl leading-relaxed">
              ...
              Industrieanlagen und mehr – in ganz Hamburg und Umgebung.
            </p>

            {/* USP Pills */}
            <div className="flex flex-wrap gap-3 mb-10">
              {['✓ 24/7 einsatzbereit', '✓ Inhabergeführt seit 20+ Jahren', '✓ Kostenlose Erstberatung'].map(
                (usp) => (
                  <span
                    key={usp}
                    className="bg-white/10 border border-white/20 text-white text-sm font-medium px-4 py-2 rounded-full backdrop-blur-sm"
                  >
                    {usp}
                  </span>
                )
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-6">
              <Button
                size="lg"
                className="h-14 px-8 text-base font-bold shadow-xl hover:scale-105 transition-transform duration-300"
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="h-14 px-8 text-base bg-white/5 border-white/30 text-white hover:bg-white/15 hover:text-white backdrop-blur-sm"
              >
            ...
            {[
              {
                ...
                text: 'Jährlich werden tausende Hamburger Unternehmen Opfer von Einbrüchen. Professioneller Objektschutz schreckt ab – bevor Schaden entsteht.',
              },
              {
                Icon: Eye,
              ...
              },
              {
                ...
                text: 'Nachts und am Wochenende ist Ihr Objekt besonders gefährdet. Unsere Revierdienste sind rund um die Uhr in Hamburg unterwegs.',
              },
            ].map(({ Icon, title, text }) => (
            ...
            <FadeIn direction="right">
              <ul className="space-y-5 mb-10">
                {[
                  ...
                  'Schnelle Reaktionszeit – wir sind in Hamburg und kennen jede Route',
                  'Maßgeschneidertes Sicherheitskonzept statt Standardlösung',
                  'Über 20 Jahre Erfahrung in der Hansestadt Hamburg',
                ].map((point) => (
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <FadeIn className="text-center max-w-3xl mx-auto mb-14">
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-slate-900 mb-4">
              Unser Objektschutz in Hamburg – Leistungen im Überblick
            </h2>
            <p className="text-slate-600 text-lg leading-relaxed">
              Jedes Objekt ist einzigartig. Deshalb entwickeln wir kein Standardprodukt, sondern
              ein individuelles Sicherheitskonzept für Ihr Unternehmen in Hamburg.
            </p>
          </FadeIn>
            ...
            <FadeIn direction="right">
              <div className="grid grid-cols-3 gap-3">
                {hamburgDistricts.map((district) => (
                  <div
                    key={district}
                    className="flex items-center gap-2 text-slate-300 text-sm bg-white/5 rounded-lg px-3 py-2.5 border border-white/10"
                  >
            ...
            <FadeIn direction="left" delay={0.2}>
              <div className="bg-primary/20 border border-primary/30 rounded-2xl p-8 mb-6">
                <h3 className="text-xl font-heading font-bold text-white mb-3">
                  Außerhalb Hamburg? Kein Problem.
                </h3>
                <p className="text-slate-300 leading-relaxed">
                  Wir arbeiten deutschlandweit auf Anfrage. Egal ob Flensburg, Bremen oder
      ...
      {/* ═══════════════════════════════════════════
          SECTION 7 — SOCIAL PROOF / REFERENZEN
      ═══════════════════════════════════════════ */}
            ...
            {[
              {
                ...
                desc: 'Füllen Sie das Formular aus oder rufen Sie an – wir antworten innerhalb von 2 Stunden.',
              },
              {
                num: '02',
                title: 'Kostenlose Vor-Ort-Analyse',
                desc: 'Wir kommen zu Ihnen nach Hamburg, begutachten Ihr Objekt und identifizieren Sicherheitslücken.',
              },
              {
                num: '03',
                title: 'Maßgeschneiderter Schutz',
                desc: 'Sie erhalten ein individuelles Angebot – keine versteckten Kosten, kein Risiko.',
              },
            ].map((step, i) => (
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-3xl">
          <FadeIn className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-slate-900">
              Häufige Fragen zu Objektschutz in Hamburg
            </h2>
          </FadeIn>
          <FadeIn delay={0.1}>
      ...
      <section id="kontakt-formular" className="py-20 bg-slate-900">
        <div className="container mx-auto px-4 max-w-7xl">
          <FadeIn className="text-center max-w-2xl mx-auto mb-14">
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-white mb-4">
              Jetzt kostenloses Angebot für Objektschutz in Hamburg anfordern
            </h2>
              ...
              <div className="bg-white/5 border border-white/10 rounded-2xl p-8 space-y-8">
                <div>
                  ...
                  <a
                    ...
                    className="text-3xl font-heading font-bold text-white hover:text-primary transition-colors block"
                  >
                    0176 214 880 84
                  </a>
                  <p className="text-slate-400 text-sm mt-1">
                    24 Stunden erreichbar, 365 Tage im Jahr
                  </p>
                </div>
